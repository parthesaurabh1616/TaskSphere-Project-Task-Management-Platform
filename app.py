...
# Sidebar Navigation
st.sidebar.markdown("## 🚀 TaskSphere")
st.sidebar.markdown("---")

page = st.sidebar.selectbox(
    "Navigate",
    ["📊 Dashboard", "📁 Projects", "✅ Tasks", "👥 Team", "📈 Analytics", "⚙️ Settings"]
)
    ...
    for task in st.session_state.tasks:
        ...
        <div class="task-card">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="color: #64748b; font-size: 0.9rem;">📅 {task['due_date']}</span>
            </div>
            <div style="margin-top: 0.5rem; font-size: 0.9rem; color: #64748b;">
                <span>📁 {task['project']}</span> • <span>👤 {task['assignee']}</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
...
<div style="text-align: center; color: #64748b; padding: 2rem 0;">
    <p>🚀 <strong>TaskSphere</strong> - Professional Project Management Platform</p>
    <p>Built with ❤️ using Streamlit | © 2024 Saurabh Parthe</p>
</div>
""", unsafe_allow_html=True)
